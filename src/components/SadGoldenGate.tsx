    ...
    <Section>
      ...
      <div style={{ position: "relative", display: "inline-block" }}>
        <BridgeSvg viewBox="0 0 400 200">
          <rect x="0" y="160" width="400" height="40" fill="#1a5276" opacity="0.5" />
          <path d="M 0,80 Q 100,20 200,80 Q 300,20 400,80" stroke="#c0392b" strokeWidth="4" fill="none" />
          ...
          <SadFace x="200" y="130" textAnchor="middle" fontSize="30">😢</SadFace>

          {[150, 200, 250].map((x, i) => (
            <g key={x}>
              <circle cx={x} cy={155} r="3" fill="#3498db" opacity="0.8">
                <animate attributeName="cy" from="155" to="200" dur={`${1.5 + i * 0.3}s`} repeatCount="indefinite" />
                <animate attributeName="opacity" from="0.8" to="0" dur={`${1.5 + i * 0.3}s`} repeatCount="indefinite" />
              </circle>
            </g>
          ))}
        </BridgeSvg>
      ...
      <Caption>The bridge has never looked so sad. And it's seen some things.</Caption>
    </Section>
  )
}
