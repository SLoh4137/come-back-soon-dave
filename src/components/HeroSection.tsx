...
const Section = styled.section`
  ...
  text-align: center;
  padding: 20px;
  background: linear-gradient(135deg, #0a0a2e 0%, #1a0a3e 25%, #2a1a4e 50%, #1a0a3e 75%, #0a0a2e 100%);
  position: relative;
  overflow: hidden;
  z-index: 2;
`
...
const HeroSection: React.FC = () => {
  return (
    <Section>
      ...
      <DramaticText>
        <p>A city weeps. The fog rolls in heavier now. The burritos taste less burrito-y.</p>
